  ...
  if (isOpen)
    return (
      ...
      >
        ...
        <div className=" p-2  rounded-xl shadow-lg rounded-sm border border-stroke bg-white  shadow-default dark:border-strokedark dark:bg-boxdark w-[99%] sd:w-[70%]   md:w-[60%] lg:w-[45%]  xl:w-[30%] h-[80vh] overflow-y-auto"  style={{ "msOverflowStyle": "none", "scrollbarWidth": "none", "position": "relative" }}>
          {/* icon ui */}
